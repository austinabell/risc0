...
async function fetchBinaryFiles() {
  // TODO write data to files and read binary data
  const receiptPromise = fs.readFile(__dirname + '/../target/TODO');
  const methodIdPromise = fs.readFile(__dirname + '/../target/TODO');
